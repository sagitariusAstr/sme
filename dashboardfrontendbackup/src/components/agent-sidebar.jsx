          ...
          <nav className="sb-sidenav accordion sb-sidenav-dark" id="sidenavAccordion">
            <div className="sb-sidenav-menu">
                <div className="nav">
                    ...
                    {/* <NavLink className="nav-link" to="/agents/employees">
                    ...
                    <NavLink className="nav-link" to="/agents/products">
                        <div className="sb-nav-link-icon"><i className="fas fa-shopping-cart"></i></div>
                        Products
                        <div className="sb-sidenav-collapse-arrow"><i className="fas fa-angle-right"></i></div>
                    </NavLink>

                    <NavLink className="nav-link" to="/agents/company">
                        <div className="sb-nav-link-icon"><i className="fas fa-companies"></i></div>
                        Companies
                        <div className="sb-sidenav-collapse-arrow"><i className="fas fa-angle-right"></i></div>
                    </NavLink> */}

                    <NavLink className="nav-link" to="/agents/visitreport">
                        <div className="sb-nav-link-icon"><i className="fas fa-companies"></i></div>
                         Visit Report
                        <div className="sb-sidenav-collapse-arrow"><i className="fas fa-angle-right"></i></div>
                    </NavLink>
                    ...
                    <NavLink className="nav-link" to="/agents/salesreport">
                        <div className="sb-nav-link-icon"><i className="fas fa-companies"></i></div>
                         Sales Report
                        <div className="sb-sidenav-collapse-arrow"><i className="fas fa-angle-right"></i></div>
                    </NavLink>

                    <NavLink className="nav-link" to="/agents/productinformation">
                        <div className="sb-nav-link-icon"><i className="fas fa-companies"></i></div>
                         Product Information
                        <div className="sb-sidenav-collapse-arrow"><i className="fas fa-angle-right"></i></div>
                    </NavLink>
